...
const USERS = {
  ...
  FABIO: { password: "5707", states: ["COMERCIAL"] },
  BARIONI: { password: "5707", states: ["COMERCIAL"] },
  ELIEL:   { password: "1234", states: ["COMERCIAL"] },
  EVERALDO:   { password: "5000", states: ["COMERCIAL"] },
  MARCELO:   { password: "8888", states: ["COMERCIAL"] },
  WILHANS:   { password: "5858", states: ["COMERCIAL"] },
  RONE:   { password: "5554", states: ["COMERCIAL"] },
  EVERALDOJR:   { password: "2000", states: ["COMERCIAL"] },
  KIEWERSON:   { password: "5554", states: ["COMERCIAL"] },
  ...
  FERNANDO:   { password: "2020", states: ["COMERCIAL"] },
